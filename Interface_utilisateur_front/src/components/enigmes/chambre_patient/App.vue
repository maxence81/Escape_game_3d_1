...
const { showComputer, showCodeBox, showPlaquette } = useGameState()
</script>

<template>
  <Scene3D />
  <HintSystem :hints="['Affiche : cherche une date', 'Code : lié à la naissance de la gamine', 'Clé : cherche près du lit']" />
